...
<header>
      <nav>
        ...
        <ul>
            ...
            <li><a href ="create-menu1.php">Create</a></li>
    ...
    <table class="content-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a class="button edit-button" href="edit-menu1.php?id=<?php echo $menu['Id'];?>">Edit</a></td>
            <td><a class="button delete-button" href="delete-menu1.php?id=<?php echo $menu['Id'];?>">Delete</a></td>
          </tr>
          <?php endforeach; ?>
        </tbody>
    </table>
